			...
			},
			{
				...
				"values": {
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "ServiceRecipientsSearchFilter_ServiceRecipientsList",
								"converters": [
									{
						...
						"from": [
							"ServiceRecipientsSearchFilter_SearchValue",
							"ServiceRecipientsSearchFilter_FilteredColumnsGroups"
						]
					}
				},
				"parentName": "ServiceRecipientsToolsFlexContainer",
			...
			},
			{
				...
				"values": {
					...
					"_filterOptions": {
						"expose": [
							{
								"attribute": "ServicesSearchFilter_ServicesList",
								"converters": [
									{
										"converter": "crt.SearchFilterAttributeConverter",
										"args": [
						...
						"from": [
							"ServicesSearchFilter_SearchValue",
							"ServicesSearchFilter_FilteredColumnsGroups"
						]
					}
				},
				"parentName": "ServicesToolsFlexContainer",
				...
				"values": {
					...
					"ServiceRecipientsList": {
						...
						"modelConfig": {
							...
							"filterAttributes": [
								{
									"name": "ServiceRecipientsSearchFilter_ServiceRecipientsList",
									"loadOnChange": true
								}
							]
						},
					...
					"ServicesList": {
						...
						"modelConfig": {
							...
							"filterAttributes": [
								{
									"name": "ServicesSearchFilter_ServicesList",
									"loadOnChange": true
								}
							]
						},
